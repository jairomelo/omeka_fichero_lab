...
f = open("texto_elementos.html", "w+", encoding='utf-8') # cambie el nombre cada vez que haga una modificación, de otra manera el archivo de sobreescribe sin advertencia.
